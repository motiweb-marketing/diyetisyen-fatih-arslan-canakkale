...
export const translations: Record<'tr' | 'en', TranslationSet> = {
  tr: {
    ...
    about: {
      title: "Diyetisyen Fatih Arslan Kimdir?",
      ...
      experienceItems: [
        ...
        "Diyetisyen Fatih Arslan Sağlıklı Yaşam ve Diyet Danışmanlık Merkezi (Kurucu - Aktif)"
      ]
    },
    testimonials: {
    ...
    appointment: {
      ...
      successDesc: "Diyetisyenimiz Diyetisyen Fatih Arslan ve asistanı, randevu detaylarını netleştirmek için en kısa sürede sizinle telefon veya WhatsApp üzerinden iletişime geçecektir.",
    ...
    contact: {
      ...
      addressLabel: "Adres",
      addressValue: "Diyetisyen Fatih Arslan, Çanakkale, Türkiye",
      phoneLabel: "Telefon",
      emailLabel: "E-posta",
    ...
    footer: {
      desc: "Uzman Klinik Diyetisyen Diyetisyen Fatih Arslan liderliğinde, bilimin ışığında sürdürülebilir beslenme rehberliği ile ideal sağlığınıza ve formunuza kavuşun.",
  ...
  en: {
    ...
    about: {
      title: "Who is Diyetisyen Fatih Arslan?",
      ...
      experienceItems: [
        ...
        "Diyetisyen Fatih Arslan Clinical Nutrition & Healthy Living Center (Founder & Active Lead)"
      ]
    },
    testimonials: {
    ...
    appointment: {
      ...
      successDesc: "Our scheduler and Dietitian Diyetisyen Fatih Arslan will contact you shortly over mobile or WhatsApp to choose the exact slot and prepare for your meeting.",
    ...
    footer: {
      desc: "Reclaim your long-term health and physique under the guidance of Expert Clinical Dietitian Diyetisyen Fatih Arslan, using verified scientific guidelines and compassionate counseling.",
